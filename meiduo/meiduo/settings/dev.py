...
SECRET_KEY = 'p8^k=7t)znpkxfohv&*h+_7fv%3n+06_mkoi#p1stf3e1r&#*2'
...
CRONJOBS = [
    ...
    ('*/1 * * * *', 'contents.utils.generate_static_index_html',
     '>> /home/python/Desktop/git/github/Shopping/meiduo/logs/crontab.log'),
]
